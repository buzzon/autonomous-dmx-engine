...
#### 6.2.3. Структура каталогов (обновлённая)
...
│   │   ├── sources/      # Источники метрик
│   │   ├── manager.ts
│   │   └── types.ts
│   ├── outputs/          # Выходные каналы
│   │   ├── sinks/        # Output sinks
│   │   ├── manager.ts
│   │   └── types.ts
...
│   ├── layout.json
│   ├── scenes.json
│   ├── scenes-rules.json # Правила выбора сцен
│   ├── effects.json      # Регистр эффектов
│   ├── styles.json
│   └── plugins.json      # Конфигурация плагинов
...
│   ├── record-audio.ts   # Запись тестовых данных
│   └── validate-configs.ts
├── tests/                # Тесты
│   ├── unit/
│   ├── integration/
